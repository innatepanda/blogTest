    ...
    render(){
        return(
            <div div className="user-main">
                    ...
                    <button href='/allArticles' className="btn-none small-text-purple"> View All <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
